...
public class MyTest {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("ztqees")
                .setOutputDir("D:\\IDEAproject\\family_service_platform\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/family_service_platform?serverTimezone=UTC")
                .setUsername("root").setPassword("ztqees");
        ...
        packageConfig.setParent("com.ztqees").setMapper("mapper")
